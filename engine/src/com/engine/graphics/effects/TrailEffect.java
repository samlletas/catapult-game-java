package com.engine.graphics.effects;
...
public class TrailEffect
{
    ...
    public TrailEffect(Color color, int size, float maxLength, float minAmplitude, float maxAmplitude,
                       float minOpacity, float maxOpacity, float travelSpeed)
    {
        if (size < 2)
        {
    ...
    private void initMesh()
    {
        ...
        {
            vertices[i] = interpolator.interpolate(maxOpacity, minOpacity,
                    (float)(i / 6) / div);
        }
    ...
    {
        return interpolator.interpolate(maxAmplitude, minAmplitude,
