...
public abstract class BaseGameplayScreen extends OverlayedScreen
{
    ...
    public BaseGameplayData getGameplayData()
    {
        return gameplayData;
    }
    ...
    {
        return screen.getName().equals(Global.ScreenNames.SETTINGS) ||
    ...
    private void initializeEvents()
    {
        ...
        gotoScoreScreenRunnable = new Runnable()
        {
            ...
            public void run()
            {
                ...
                GameOverScreen gameOverScreen = (GameOverScreen)screenManager.getScreen(Global.ScreenNames.GAME_OVER);
                gameOverScreen.setGameplayScreen(BaseGameplayScreen.this);
