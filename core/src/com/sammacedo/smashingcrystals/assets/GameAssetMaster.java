...
public class GameAssetMaster extends BaseAssetMaster
{
    ...
    protected void addToSyncQueue(Array<IAsset> queue)
    {
        ...
        queue.add(assets.musics.menu);
        queue.add(assets.musics.timeAttack);

        queue.add(assets.sounds.crystalBreak);
        queue.add(assets.sounds.shoot);
        queue.add(assets.sounds.point);
        queue.add(assets.sounds.damage);
        queue.add(assets.sounds.count);
        queue.add(assets.sounds.success);
    }
