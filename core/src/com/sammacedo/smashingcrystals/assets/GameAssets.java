package com.sammacedo.smashingcrystals.assets;
...
public final class GameAssets
{
    ...
    {
        public Asset<Music> menu;
        public Asset<Music> timeAttack;

        private Musics()
        {
            menu = new Asset<Music>("music/menu.mp3", Music.class);
            timeAttack = new Asset<Music>("music/timeAttack.ogg", Music.class);
        }
    }
    ...
    public final class Sounds
    {
        ...
        public Asset<Sound> damage;
        public Asset<Sound> count;
        public Asset<Sound> success;
        ...
        private Sounds()
        {
            ...
            damage = new Asset<Sound>("sounds/damage.wav", Sound.class);
            count = new Asset<Sound>("sounds/count.ogg", Sound.class);
            success = new Asset<Sound>("sounds/success.ogg", Sound.class);
        }
    }
}
